...
const Consultation = () => {
  return (
    <div className="bg-secondary  w-[22rem] h-[11rem] rounded-[2.7rem] flex flex-col overflow-hidden my-4 py-8 px-8">
        ...
        <div className='w-full flex'>
            <div className='w-1/2'>
                ...
                <div className='bg-tertiary w-[70%] flex justify-between align-middle px-4 py-2 rounded-2xl mt-4'>
