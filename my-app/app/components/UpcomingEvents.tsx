...
const UpcomingEvents = () => {
  return (
    <div className='bg-secondary w-[28rem] h-[14rem] rounded-[2.7rem] flex flex-col overflow-hidden my-4 py-6 px-8'>
        <div className='flex align-middle'>
            <div className='bg-bright w-14 p-2 rounded-[12rem] flex justify-center'>
                <FaArrowRight className='text-black text-2xl'/>
            </div>
            <h1 className='text-[#CCC] font-semibold my-auto ml-4 text-[1.4rem]'>Upcoming Events</h1>
        </div>
        <div className='flex mt-6'>
            <div className='w-1/2 flex justify-center'>
                ...
                <div className='h-[5.5rem] w-[5.5rem] rounded-full overflow-hidden my-auto'>
                    <img src='https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png' alt='doctor' className='w-96'/>
                </div>
                </div>
            </div>
            <div className='w-1/2'>
